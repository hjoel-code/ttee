...
import PackageModal from "../package-modal/modal.component";
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 2 }}>
          <PackageModal
            ...
            RenderComponent={(props) => (
              <SkillComponent {...props} icon={<Connect size={48} />} />
            )}
          />
          ...
          <PackageModal
            ...
            package_name={"One-on-One Package"}
            overviews={[]}
            RenderComponent={(props) => (
              <SkillComponent {...props} icon={<User size={48} />} />
            )}
          />
        </SimpleGrid>
      </SimpleGrid>
